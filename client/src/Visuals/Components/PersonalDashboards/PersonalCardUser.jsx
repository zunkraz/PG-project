    ...
    return (
        <div className='h-auto w-80 pt-4'>
            <div className='flex justify-center bg-gray-0 rounded-2xl justify-center '>
                ...
                {isVerified&& <div className='flex justify-center font-lg'><span>Usuario Verificado</span><FcApproval class='font-xl ml-2'/></div>}
                {!isVerified && <div className='flex justify-center font-lg'><span>Usuario no verificado</span></div>}
