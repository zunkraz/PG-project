...
//USER DELETE
router.delete('/users/:username', passport.authenticate('jwt', {session: false}), (req,res,next)=>{
...
//USER UPDATE
router.put('/users/:username', passport.authenticate('jwt', {session: false}), (req,res,next)=>{
  let {username} = req.params;
...
//APPOINTMENT DELETE
router.delete('/appointment/:id', passport.authenticate('jwt', {session: false}), (req,res,next)=>{
  let {id} = req.params;
...
//APPOINTMENT UPDATE
router.put('/appointment/:id', passport.authenticate('jwt', {session: false}), (req,res,next)=>{
  let {id} = req.params;
...
//TIP CREATE
router.post('/tips', passport.authenticate('jwt', {session: false}), (req,res,next)=>{
  let {text} = req.body;
...
//TIP UPDATE
router.put('/tips/:id', passport.authenticate('jwt', {session: false}), (req,res,next)=>{
  let {id} = req.params;
